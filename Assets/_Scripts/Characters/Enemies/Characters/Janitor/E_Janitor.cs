...
namespace MyCode.Enemy
{
    ...
    public class E_Janitor : MonoBehaviour
    {
        ...
        private MyCode.Player.P_Health p_health;
        ...
        private MyCode.Player.P_Movement p_movement;
        private MyCode.Player.P_Camera p_camera;
        ...
        public void Awake()
        {
            ...
            p_movement = player.GetComponent<MyCode.Player.P_Movement>();
            p_camera = player.GetComponent<MyCode.Player.P_Camera>();
